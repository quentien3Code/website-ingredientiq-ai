...
from .views import LeadershipView, StayconnectedView, ContactView, TermsandConditionsView, PrivacyPolicyView, BlogsView, FaqsView, TestimonialsView, AboutusView, PlatformsView, InfoView, RelatedPostsView, DownloadPDFView, VideoView, DownloadRequestView
